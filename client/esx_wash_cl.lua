...
RegisterNetEvent('esx_lavagemdedinheiro:closeWASH')
AddEventHandler('esx_lavagemdedinheiro:closeWASH', function()
	SetNuiFocus(false)
	menuIsShowed = false
	SendNUIMessage({
		hideAll = true
...
RegisterNUICallback('escape', function(data, cb)
  	TriggerEvent('esx_lavagemdedinheiro:closeWASH')
	cb('ok')
end)

RegisterNUICallback('deposit', function(data, cb)
	TriggerServerEvent('esx_lavagemdedinheiro:deposit', data.amount)
	cb('ok')
end)

RegisterNUICallback('withdraw', function(data, cb)
	TriggerServerEvent('esx_lavagemdedinheiro:withdraw', data.amount)
	cb('ok')
end)
