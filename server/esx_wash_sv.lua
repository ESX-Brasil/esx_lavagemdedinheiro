...
RegisterServerEvent('esx_lavagemdedinheiro:withdraw')
AddEventHandler('esx_lavagemdedinheiro:withdraw', function(amount)
	...
	if amount == nil or amount <= 0 or amount > accountMoney then
		...
		TriggerClientEvent('esx_lavagemdedinheiro:closeWASH', _source)
	end
end)